...
[params_con, fval_con] = fmincon(J, initial_params, [], [], [], [], LB, UB, [],options_con)
[params_con, fval_conn,exitflag, output, lambda]= fmincon(J, params_con, [], [], [], [], LB, UB, [],options_con)
t_con=toc;
save('params_con.mat','params_con','t_con')
%%
